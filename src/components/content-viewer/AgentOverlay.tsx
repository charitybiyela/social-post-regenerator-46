...
export const AgentOverlay = ({ visible, onClose, onSendToMain }: AgentOverlayProps) => {
  ...
  return (
    <motion.div
      ...
      className={`absolute left-4 bottom-4 max-w-xs z-10 ${isTransparent ? 'bg-background/80' : 'bg-background'} backdrop-blur-md rounded-lg shadow-lg border border-border/50 dark:bg-background/90 dark:border-border/30`}
      style={{ width: "300px" }}
    >
